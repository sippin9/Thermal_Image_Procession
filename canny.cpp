...
//  Canny Edge Detector
//
//  Created by Hasan Akg¨¹n on 21/03/14.
//  Copyright (c) 2014 Hasan Akg¨¹n. All rights reserved.
//
#include <iostream>
#include <cmath>
#ifndef M_PI
...
/*
    Usage: cv::String filePath = "/Users/hasanakg/Desktop/stpietro.jpg"; //Filepath of input image
    canny cny(filePath);
*/
...
canny::canny(String filename)
{
    ...
    else
    {
        ...
        if(img.channels()!=1) cv::cvtColor(img, grayscaled, cv::COLOR_RGB2GRAY); //Grayscale the image
